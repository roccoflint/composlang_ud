...
def initialize_stim_server(
    ...
    def get_data_and_open_count():
        ...
        # reflect any manual changes made in the meantime... ANY other changes ANYwhere within the code to the database are immediately propogated to disk
    ...
    def test_connection():
        ...
        return "Compositionality Language Stimuli Server is up and running!"
...
parser = ArgumentParser("ComposLang human study server")
parser.add_argument(
    "--host",
